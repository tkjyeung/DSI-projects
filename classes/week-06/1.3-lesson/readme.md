...
For this exercise, copy the JSON data from the [starter-code](./code/starter-code/test.json) folder and insert it in the web app above, click "Validate".
...
The provided JSON is purposefully invalid. Please make the necessary changes to fix the errors.
...
- Go to [python-apis.md](./python-apis.md)
