...
|:-:|---|---|
| left  | use calling frame’s index   | All of A and whatever matches B  |
| right  | use input frame’s index  | All of B and whatever matches A  |
| outer  | form union of indexes  | All of A and all of B  |
| inner  | use intersection of indexes  | Only whatever overlaps between A and B  |


**Check:** In pairs draw a left, right, inner, and outer join. Then, show the other person and explain it to them.

* If you've used SQL before, you should [check out the comparison between SQL and Pandas joins](http://pandas.pydata.org/pandas-docs/stable/comparison_with_sql.html). 
* If you are seeing joins for the first time, do not be discouraged if all these joins are confusing for you. Please go through each of the examples slowly and you will gradually get it.

- [Official Documentation: join](http://pandas.pydata.org/pandas-docs/stable/generated/pandas.DataFrame.join.html)
- [Official Documentation: merge](http://pandas.pydata.org/pandas-docs/version/0.15.2/merging.html)
...
- [Official Documentation: concat](http://pandas.pydata.org/pandas-docs/stable/generated/pandas.concat.html)
